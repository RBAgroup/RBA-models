...
- *Arabidopsis thaliana Col-0* generic cell
- *Arabidopsis thaliana Col-0* with temperature dependence
- *Bacillus subtilis 168* WT strain
- *Escherichia coli K12* WT strain
- *Escherichia coli K12* strain fixing CO<sub>2</sub>
- *Escherichia coli K12* with temperature dependence
...
Models of A. thaliana B. subtilis and E. coli were developed by INRAE, please cite (https://doi.org/10.1016/j.ymben.2019.06.001) when using these models.
...
Please note that in the models for *Ralstonia eutropha* and *Vibrio natriegens* the actual rba model (according to the rbaml2 standard) is located in a subdirectory called model.